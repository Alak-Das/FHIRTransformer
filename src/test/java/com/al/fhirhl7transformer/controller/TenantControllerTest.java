...
public class TenantControllerTest {
        ...
        @MockitoBean
        private com.al.fhirhl7transformer.service.TransactionService transactionService;
        ...
        public void testGetTenantTransactions_HandlesNullStatus() throws Exception {
                ...
                // Mock Page result
                org.springframework.data.domain.Page<com.al.fhirhl7transformer.model.TransactionRecord> page = org.springframework.data.domain.Page
                                .empty();
                ...
                java.util.List<com.al.fhirhl7transformer.dto.StatusCount> statusCounts = new java.util.ArrayList<>();
                statusCounts.add(new com.al.fhirhl7transformer.dto.StatusCount(null, 5)); // The problematic case
                statusCounts.add(new com.al.fhirhl7transformer.dto.StatusCount("COMPLETED", 10));
