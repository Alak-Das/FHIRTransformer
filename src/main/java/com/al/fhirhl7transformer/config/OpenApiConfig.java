...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                ...
                .tags(List.of(
                        new Tag().name("Conversion").description("HL7 ↔ FHIR conversion endpoints"),
                        new Tag().name("Tenant Management").description("Multi-tenant administration endpoints"),
                        new Tag().name("Subscriptions").description("FHIR Subscription management"),
                        new Tag().name("Transactions").description("Transaction status and audit endpoints")))
