...
| **GET** | `/api/tenants/{id}/transactions` | `ADMIN` | **Audit Logs**: Retrieve history of transactions for a specific tenant. | Params: `startDate`, `endDate` (ISO 8601) | `200 OK` `{ "totalCount": 5, "statusCounts": {"PROCESSED": 5}, "transactions": [...] }` |
